...
<body>
	<div class="login-box">
		<form action="viewInsurance" method="get">
		<h2>View an Insurance Detail </h2><br>
			<div class="user-box">
				<input type="text" name="vehPlateNumber" required=""> <label>Provider Name</label>
			</div><a href="#">
<span></span>
<span></span>
<span></span>
			<button type="submit">VIEW</button></a>
		</form>
...
<span></span>
			...
			<button type="submit">VIEWALL</button></a>
		</form></div>
</body>
</html>